!function(root, factory) {
	...
	*/
    ...
    function(module, exports, __webpack_require__) {
        ...
        var NodeRendererDefault = function(_Component) {
            ...
            return _inherits(NodeRendererDefault, _Component), _createClass(NodeRendererDefault, [ {
                key: "render",
                value: function() {
                    var _props = this.props, scaffoldBlockPxWidth = _props.scaffoldBlockPxWidth, toggleChildrenVisibility = _props.toggleChildrenVisibility, connectDragPreview = _props.connectDragPreview, connectDragSource = _props.connectDragSource, isDragging = _props.isDragging, isOver = _props.isOver, canDrop = _props.canDrop, node = _props.node, draggedNode = _props.draggedNode, path = _props.path, treeIndex = _props.treeIndex, isSearchMatch = _props.isSearchMatch, isSearchFocus = _props.isSearchFocus, buttons = _props.buttons, className = _props.className, _props$style = _props.style, style = void 0 === _props$style ? {} : _props$style, otherProps = (_props.startDrag, 
                    _props.endDrag, _objectWithoutProperties(_props, [ "scaffoldBlockPxWidth", "toggleChildrenVisibility", "connectDragPreview", "connectDragSource", "isDragging", "isOver", "canDrop", "node", "draggedNode", "path", "treeIndex", "isSearchMatch", "isSearchFocus", "buttons", "className", "style", "startDrag", "endDrag" ])), handle = void 0;
    ...
    function(module, exports, __webpack_require__) {
        ...
        var _extends = Object.assign || function(target) {
        ...
        }(), _react = __webpack_require__(4), _react2 = _interopRequireDefault(_react), _treeNode = __webpack_require__(19), _treeNode2 = _interopRequireDefault(_treeNode), TreeNode = function(_Component) {
            function TreeNode() {
            ...
            return _inherits(TreeNode, _Component), _createClass(TreeNode, [ {
                key: "render",
                value: function() {
                    var _props = this.props, children = _props.children, listIndex = _props.listIndex, swapFrom = _props.swapFrom, swapLength = _props.swapLength, swapDepth = _props.swapDepth, scaffoldBlockPxWidth = _props.scaffoldBlockPxWidth, lowerSiblingCounts = _props.lowerSiblingCounts, connectDropTarget = _props.connectDropTarget, isOver = _props.isOver, draggedNode = _props.draggedNode, canDrop = _props.canDrop, treeIndex = _props.treeIndex, otherProps = (_props.node, 
                    _props.path, _objectWithoutProperties(_props, [ "children", "listIndex", "swapFrom", "swapLength", "swapDepth", "scaffoldBlockPxWidth", "lowerSiblingCounts", "connectDropTarget", "isOver", "draggedNode", "canDrop", "treeIndex", "node", "path" ])), passProps = (otherProps.getPrevRow, 
                    otherProps.maxDepth, otherProps.dragHover, _objectWithoutProperties(otherProps, [ "getPrevRow", "maxDepth", "dragHover" ])), scaffoldBlockCount = lowerSiblingCounts.length, scaffold = [];
                    ...
                    }), connectDropTarget(_react2.default.createElement("div", _extends({}, passProps, {
